...
def setup_commands(bot):
    ...
    async def update_command(interaction: discord.Interaction):
        ...
        try:
            ...
            embed.add_field(
                ...
                value="Gracias a toda la comunidad por su apoyo constante y feedback valioso. Esta actualización incluye muchas de las sugerencias que nos han enviado.\n\n**¡Sigan enviando sus ideas para las próximas actualizaciones!**",
                inline=False
            )
    ...
    logger.info("<:verify:1396087763388072006> Comando /update configurado exitosamente")
    return True
